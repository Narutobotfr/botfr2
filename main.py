...
client_token = '7255915165:AAEAl_QGZznRt6yfKe0rrYngQD0dQkuWmEU'

admin_ids = [6604452400, 6774116743, 5233465860]  # Example admin IDs
...
credit = {}
generated_codes = []
vip = [6604452400,5233465860,1756796106]
...
async def report(event):
    ...
    if event.text.strip() == "/bh":
        ...
        return            
    if credit_value <= 0:
        await event.respond('**Credits Finished! Try /refresh** or \nBuy 𝗣𝗿𝗲𝗺𝗶𝘂𝗺 for Unlimited usage 👑.\n𝗦𝗵𝗼𝗽 ➜ [Otaku](https://OtakuNetworks/product/gateway-v2)',reply_to=event, parse_mode='MarkdownV2')
    else:
                global edit
